/*
  # Complete ParkPass Database Schema

  1. Enums and Types
    - Create all necessary enum types for the application
    
  2. Core Tables
    - profiles: User profiles and authentication data
    - vehicles: User vehicles information
  ...
  5. Functions and Triggers
    ...
    - Automatic event tracking triggers
*/
...
CREATE POLICY "Admins can read usage statistics" ON usage_statistics
  FOR SELECT TO authenticated
  USING (
    EXISTS (
